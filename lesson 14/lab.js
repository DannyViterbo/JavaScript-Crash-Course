//questions.js
questions = new Array();
questions.push("Who played Punky Brewster in the eary 80's TV sitcom of the same name?");
...
questionOneAnswers = new Array("Sloeil Moon Fyre", "Meeno Poolous", "Heather Locklear", "Molly Ringwald");
questionTwoAnswers = new Array("Jim Henson", "Art Van Delay", "Caroll Spinney", "Bob Keeshan");
questionThreeAnswers = new Array("United States", "Isreal", "France", "Canada");
